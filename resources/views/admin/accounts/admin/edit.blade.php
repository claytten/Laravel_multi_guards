...
<div class="page-header row no-gutters py-4">
    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        <span class="text-uppercase page-subtitle">Update Admin</span>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.admin.update',$employee->id)}}" method="POST" class="form" enctype="multipart/form-data">
            {{ csrf_field() }}
            <input type="hidden" name="_method" value="PUT" readonly>
            <input type="hidden" name="newPassword" value="oldPassword" readonly>
            <div class="form-group">
                <label for="role">Access Level</label>
                <select name="role" id="role" class="form-control acl_select @error('role') is-invalid @enderror">
...
<div class="modal fade" id="passwordModal" tabindex="-1" role="dialog" aria-labelledby="passwordModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form class="modal-content" id="passwordModalForm" action="{{ route('admin.admin.update',$employee->id)}}" method="POST" >
            {{ csrf_field() }}
            <input type="hidden" name="_method" value="PUT" readonly>
